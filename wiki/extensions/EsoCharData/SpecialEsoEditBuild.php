...
class SpecialEsoEditBuild extends SpecialPage 
{
	...
	function __construct() 
	{
		...
		$this->$buildDataEditor = new EsoBuildDataViewer();
	...
	function execute( $par ) 
	{
		...
		$out->addHeadItem("uesp-esobuildeditor2-css", "<link rel='stylesheet' href='http://esobuilds.uesp.net/resources/resources/esoEditBuild.css' />");
		$out->addHeadItem("uesp-esobuildeditor2-js", "<script src='http://esobuilds.uesp.net/resources/resources/esoEditBuild.js'></script>");
