...
function CreateLegendsTables($db)
{
	$query = "CREATE TABLE IF NOT EXISTS cards (
						...
						rarity TINYTEXT NOT NULL DEFAULT '',
						attribute TINYTEXT NOT NULL DEFAULT '',
						attribute2 TINYTEXT NOT NULL DEFAULT '',
						attribute3 TINYTEXT NOT NULL DEFAULT '',
						`set` TINYTEXT NOT NULL DEFAULT '',
						`class` TINYTEXT NOT NULL DEFAULT '',
						obtainable TINYINT(1) NOT NULL DEFAULT 0,
						`unique` TINYINT(1) NOT NULL DEFAULT 0,
						training1 TINYTEXT NOT NULL DEFAULT '',
						trainingLevel1 TINYINT NOT NULL,
						training2 TINYTEXT NOT NULL DEFAULT '',
						trainingLevel2 TINYINT NOT NULL,
						uses TINYTEXT NOT NULL DEFAULT '',
						PRIMARY KEY (name(32)),
	...
	$query = "CREATE TABLE IF NOT EXISTS deletedCards (
						...
						`unique` TINYINT(1) NOT NULL DEFAULT 0,
						training1 TINYTEXT NOT NULL DEFAULT '',
						trainingLevel1 TINYINT NOT NULL DEFAULT '',
						training2 TINYTEXT NOT NULL DEFAULT '',
						trainingLevel2 TINYINT NOT NULL DEFAULT '',
						uses TINYTEXT NOT NULL DEFAULT '',
