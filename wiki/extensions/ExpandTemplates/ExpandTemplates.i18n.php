...
$messages['ja'] = array(
	...
	'expandtemplates-desc' => '[[Special:ExpandTemplates|テンプレート パーサー関数・変数を展開し]]、展開されたウィキテキストと生成されたプレビュー ページを表示する',
...
<nowiki>{{</nowiki>#എങ്കിൽ:…}} തുടങ്ങിയ പാഴ്‌സർ ഫങ്ഷനുകളും
...
മീഡിയവിക്കിയിലെ ബന്ധപ്പെട്ട പാഴ്‌സർ സൗകര്യം ഉപയോഗിച്ചാണ് ഇത് സാദ്ധ്യമാക്കുന്നത്.',
