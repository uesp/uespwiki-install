 ...
 */
/* UESP modifications:
   1) in removeHTMLtags, add 2 lines of code
      purpose: call efUespSanitizerAddHtml( $htmlpairs )
      needs to be called after htmlpairs is initialized, and before conversion to hashtables
   2) in setupAttributeWhitelist, add 2 lines of code
      purpose: call efUespSanitizerAddWhitelist( $whitelist, $common );
      needs to be called after whitelist is initialized and before return at end of function
*/
...
class Sanitizer {
	...
	static function removeHTMLtags( $text, $processCallback = null, $args = array() ) {
		...
		if ( !$staticInitialised ) {
			...
			if( UESP_CUSTOM_CODE_ACTIVE===true )
				efUespSanitizerAddHtml( $htmlpairs );
	...
	static function setupAttributeWhitelist() {
		...
		if( UESP_CUSTOM_CODE_ACTIVE===true )
			efUespSanitizerAddWhitelist( $whitelist, $common );
		return $whitelist;
	}
