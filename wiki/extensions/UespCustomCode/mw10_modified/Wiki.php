 ...
 */
/* UESP modifications:
   1) in initializeSpecialCases, insert 7 + 2 lines of code  (marked by UESP Start and UESP End tags)
      purpose: call efUespInitializeSearch() instead of three lines of default processing
      specifically, must prevent code from calling wfSpecialSearch()
      This tweak is no longer necessary as of MW1.14 (wfSpecialSearch is no longer called anywhere in this file)
*/
...
/*---- UESP Start ----*/
// Bad Mediawiki: it isn't using proper hooks here, so it's not automatically using replacement page
// By MW1.14, this is fixed, so this chunk of code is no longer needed
			if( UESP_CUSTOM_CODE_ACTIVE===true ) {
				$title = efUespInitializeSearch();
			}
			else {
