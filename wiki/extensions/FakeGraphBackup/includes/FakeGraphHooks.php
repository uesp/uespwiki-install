	...
	\MediaWiki\Hook\ParserFirstCallInitHook */
{
	...
	public static function doGraph($input, array $args, Parser $parser, PPFrame $frame): string
	{
		...
		return $parser->recursiveTagParse('{{Notice|color=blue|image=[[File:Icon-Information.png|32px]]|width=100%|margin=2px|Graphs are currently disabled due to a security issue.}}');
	}
}
