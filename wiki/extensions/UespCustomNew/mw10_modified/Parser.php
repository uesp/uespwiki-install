 ...
 */
/* UESP modifications:
   1) in pstPass2, add 2 lines of code
      purpose: call efUespPreSaveTransform( $text, $this->mTitle )
      needs to be called before standard processing of context links
*/
...
'<head><title>test</title></head><body>'.$text.'</body></html>';
	...
	function pstPass2( $text, &$stripState, $user ) {
		...
		if( UESP_CUSTOM_CODE_ACTIVE===true )
			efUespPreSaveTransform( $text, $this->mTitle );
