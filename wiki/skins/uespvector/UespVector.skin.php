 ...
 * @ingroup Skins
 */
class SkinUespVector extends SkinTemplate {

	protected static $bodyClasses = array( 'vector-animateLayout' );

	var $skinname = 'uespvector', $stylename = 'uespvector',
		$template = 'UespVectorTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModules( array( 'skins.uespvector.js', 'skins.uespvector.collapsibleNav' ) );
	}
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$styles = array( 'mediawiki.skinning.interface', 'skins.uespvector.styles' );
 ...
 * @ingroup Skins
 */
class UespVectorTemplate extends BaseTemplate {
	...
	public function execute() {
		global $wgUser, $wgVectorUseIconWatch;
...
?>
		...
		<div id="mw-navigation">
			...
			<div id="mw-panel">
					<div id="p-logo" role="banner"><a style="background-image: url(<?php $this->text( 'logopath' ) ?>);" href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] ) ?>" <?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'p-logo' ) ) ?>></a></div><?php
...
<div class="portal body" id="p-googleplus">
